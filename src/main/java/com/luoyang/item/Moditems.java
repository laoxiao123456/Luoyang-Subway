...
public class Moditems {
    ...
    public static  final Item PLATFORM_DOOR_GLASS = registerItem("platform_door_glass", new Item(new Item.Settings()));
    public static  final Item RAILING_01 = registerItem("railing_01", new Item(new Item.Settings()));
    public static  final Item SIGN_3E = registerItem("sign_3e", new Item(new Item.Settings()));
